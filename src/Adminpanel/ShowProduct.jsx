...
function ShowProduct() {
  ...
  useEffect(() => {
    axios.get("https://electronicbackend-vtjh.onrender.com/productapi").then((res) => {
      setproductapi(res.data.productdata);
    });
  }, []);

  let deleteproduct = (id) => {
    axios.post("https://electronicbackend-vtjh.onrender.com/deleteproduct", { id }).then((res) => {
  ...
  let updateStock = async (id, status) => {
    try {
      const res = await axios.put(`https://electronicbackend-vtjh.onrender.com/stock/${id}`, { status });
      toast.success(res.data.msg);
      setproductapi((prev) =>
